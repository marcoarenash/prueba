class ProyectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @proyect.save
        format.html { redirect_to @proyect, notice: 'Proyecto ha sido creado.' }
  ...
  def update
    respond_to do |format|
      if @proyect.update(proyect_params)
        format.html { redirect_to @proyect, notice: 'Proyecto ha sido actuslizado.' }
  ...
  def destroy
    @proyect.destroy
    respond_to do |format|
      format.html { redirect_to proyects_url, notice: 'Proyecto ha sido eliminado.' }
  ...
  private
    ...
    def proyect_params
      params.require(:proyect).permit(:titulo, :descripcion)
    end
end
